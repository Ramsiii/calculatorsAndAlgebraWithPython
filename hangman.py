# TODO: add a hangman graphic with addditional body parts for every wrong guess.

word = input("Player 1, please choose a word: ")
...
while guess <= num_guesses and '-' in hidden_word:
    print(hidden_word)
    user_input = input(f'Player 2, enter a character (guess #{guess}): ')
...
print(f'The word was {word}. It took you {guess} guesses.')
